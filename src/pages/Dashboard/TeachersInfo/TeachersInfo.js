        ...
        <div className="bg-dark container-fluid  ">
            ...
            <div className="row">
                                ...
                                >
                                    <div className="d-flex justify-content-center">
                                        <img
                                            ...
                                            src={`data:image/*;base64,${teacher.image}`}
                                            alt=""
                                        />
                                    </div>
                ...
                <div className="col-md-4">
                    <img
                        className="position-fixed img-fluid  pe-5"
                        src="https://i.ibb.co/B3VXc0Y/587-5872482-school-vector-teacher-illustration-hd-png-download-removebg-preview.png"
                        alt=""
                    />
                </div>
            </div>
